...
func Convert(dst, bech32str string) string {
	...
	if err != nil {
		log.Printf("decoding Bech32 address failed: must provide an valid bech32 address")
		return ""
	}
...
func ConvertFromHex(dst, hexStr string) string {
	...
	if err != nil {
		log.Printf("decoding hex address failed: must provide an valid hex address")
		return ""
	}
